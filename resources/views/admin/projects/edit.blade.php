<x-app-layout>
    ...
    <!-- Contact Form -->
    <form id="new-project-form" class=" material" method="post" action="{{route('admin-projects-update',['slug'=>$project->slug])}}" enctype="multipart/form-data">
...
{{--                <span class="material__underline"></span>--}}
            ...
            <div class="col-md-6 material__form-group form-group">
                <span>Title</span>
                <input type="text" name="title" id="title" class="form-input material__input" value="{{$project->title}}" required="">
{{--                <label for="name" class="material__label">Title</label>--}}
            ...
            <div class="col-md-6 material__form-group form-group">
                <span>Client</span>
                <input type="text" name="client" id="client" class="form-input material__input" value="{{$project->client}}" required="">
{{--                <label for="name" class="material__label">Client</label>--}}
            ...
            <div class="col-md-6 material__form-group form-group">
                <span>Location</span>
                <input type="text" name="location" id="location" class="form-input material__input" value="{{$project->location}}" required="">
...
{{--                <input type="text" name="completed_date" id="completed_date" class="form-input material__input" required="">--}}
                <input  id='datetimepicker' name="completed_date"  class="form-control material__input" value="{{date("m/d/Y",$project->completed_date)}}" type="text">
{{--                <label for="datetimepicker" class="material__label"> Completed Date</label>--}}
            ...
            <div class="col-md-12 material__form-group form-group">
                <span>Body</span>
                <textarea id="" name="body" rows="70" class="form-input material__input" required="">{{$project->body}}</textarea>
